...
import { LayoutDashboard, Map, CloudRain, Camera, BarChart3, ShieldAlert, Settings, PhoneCall, Users2, TrendingUp, Activity, UserPlus } from 'lucide-react';
...
const ADMIN_NAV_ITEMS = [
  { to: '/autorite/authorities', label: 'Gérer les autorités', icon: UserPlus, adminOnly: true },
];
